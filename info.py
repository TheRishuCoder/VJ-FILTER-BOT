...
PICS = (environ.get('PICS', 'https://envs.sh/L8z.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/L8Y.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/L8C.jpg")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002243998537')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
MULTIPLE_DATABASE = bool(environ.get('MULTIPLE_DATABASE', False)) # Set True or False

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Moviedetsbsss:Radheradhe@cluster0.wavdb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # IF Multiple Database Is False Then Fill Only This Database Url.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Moviedetsbsss")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/f172313e3a549e2ef685f.jpg')
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://Movieclone:movie12321@cluster0.bsbne.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'RishuMood') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
